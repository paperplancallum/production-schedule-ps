...
const FIELD_OPTIONS = [
  { value: 'vendor_name', label: 'Supplier Name', type: 'text' },
  { value: 'vendor_type', label: 'Vendor Type', type: 'select', options: [
    { value: 'supplier', label: 'Supplier' },
    { value: 'inspection_agent', label: 'Inspection Agent' }
  ]},
  { value: 'vendor_status', label: 'Status', type: 'select', options: [
            ...
            {conditions.map((condition, condIndex) => {
              ...
              return (
                <div key={condition.id} className="flex items-center gap-2">
                  ...
                  {showValueInput && (
                    <>
                      {isMultiSelect && selectedField?.type === 'select' ? (
                        <div className="w-48">
                          <DropdownMenu>
