...
import { X, Plus, Trash2, Filter, Check, ChevronDown, RefreshCw } from 'lucide-react'
...
export default function ProductFilters({ onFiltersChange, suppliers = [], onRefresh, refreshing }) {
